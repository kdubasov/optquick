    ...
    return (
        <div className={`AddProduct w-100 p-1 my-3 border d-flex flex-wrap`}>
            ...
            <Form className={'w-100 mx-1'}>
                ...
                <InputGroup className="mb-1 px-1">
                    <Form.Select>
                        <option>Варианты доставки*</option>
                    </Form.Select>
                    <Form.Select>
                        <option>Варианты оплаты*</option>
                    </Form.Select>
                ...
                <InputGroup className="mb-2 px-1">
                    ...
                    <Form.Control placeholder={'Место нахождения товара'} />
                    <Form.Control placeholder={'Размеры'} />
                    <Form.Control placeholder={'Срок доставки (дни)'} />
                </InputGroup>
