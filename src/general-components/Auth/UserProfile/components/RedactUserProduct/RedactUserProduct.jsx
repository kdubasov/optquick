                ...
                nowProduct ?
                    <>
                        ...
                        <p className="small warning">
                            ...
                            Вы можете написать в поддержку и мы поможем удалить или добавить новые фото в ваш товар.
                            В скором времени данная функция будет добавлена в функционал приложения.
